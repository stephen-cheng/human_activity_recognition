...
def get_args():
    ...
    # Add arguments
    parser.add_argument(
        '-i', '--input', type=str, help='OPPORTUNITY zip file',
		default="data/OpportunityUCIDataset.zip", required=False)
    parser.add_argument(
        '-o', '--output', type=str, help='Processed data file', 
		default="ppChallenge_gestures", required=False)
    parser.add_argument(
